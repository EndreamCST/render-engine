...
void SkinnedMesh::InitMesh(unsigned int Index, const aiMesh *paiMesh, std::vector<glm::vec3> &Positions,
                           std::vector<glm::vec3> &Normals,
...
void SkinnedMesh::InitMeshMaterial(const aiMaterial *pMaterial, std::vector<SkinnedTexture> &mesh_textures) {
...
SkinnedTexture SkinnedMesh::LoadMaterialFile(const aiMaterial *pMaterial, aiTextureType aiType, TextureEnum texEnum) {
    aiString Path;
    ...
    SkinnedTexture tex(GL_TEXTURE_2D, FullPath, texEnum);
